...
public class JfxOnEnterKeyPressedEventSubscription implements EventHandler<KeyEvent> {

    private final Node sender;
    private final ISubscriptionEvent<SubscriptionEventArgsGeneric<KeyEvent>> event;

    public JfxOnEnterKeyPressedEventSubscription(Node sender, ISubscriptionEvent<SubscriptionEventArgsGeneric<KeyEvent>> event) {
        this.sender = sender;
        this.event = event;
        this.attach();
    }
    ...
    private void attach() {
        this.sender.addEventHandler(KeyEvent.KEY_PRESSED, this);
    }
