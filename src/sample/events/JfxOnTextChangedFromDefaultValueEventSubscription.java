...
public class JfxOnTextChangedFromDefaultValueEventSubscription implements ChangeListener<String> {
    ...
    public JfxOnTextChangedFromDefaultValueEventSubscription(TextInputControl sender, ISubscriptionEvent<PropertyChangedSubscriptionEventArgs<String>> event, Supplier<String> defaultValueSupplier) {
        this.sender = sender;
        this.event = event;
